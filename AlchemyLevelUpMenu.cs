    ...
    public class AlchemyLevelUpMenu : IClickableMenu
    {
        ...
        public override void update(GameTime time)
        {
            ...
            if (Game1.random.NextDouble() < 0.03)
            {
                ...
                this.littleStars.Add(new TemporaryAnimatedSprite(Game1.mouseCursors.Name, new Rectangle(364, 79, 5, 5), 80f, 7, 1, position, false, false, 1f, 0f, Color.White, (float)Game1.pixelZoom, 0f, 0f, 0f, false)
                {
                    local = true
                });
            }
